...
@section('main_content')
    <div class="container-fluid mt-5 px-2 px-lg-5">
        ...
        <div class="row mx-auto my-3 d-flex justify-content-between">
            ...
            <a href="/categories" class="d-block btn btn-success text-white w-auto">Danh mục sản phẩm</a>
        </div>
        ...
        <a href="/" class="d-inline-block btn btn-primary text-white w-auto mt-4 mb-3">&larr; Trang chủ</a>
    </div>
